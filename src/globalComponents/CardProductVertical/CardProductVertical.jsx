...
export const CardProductVertical = ({ img, title, price, footer }) => {


  return (
    <div className="CardProductVertical bg-background02 rounded-xl overflow-hidden mr-3">
      ...
      <div className="text-white flex flex-col px-2.5 pt-2.5">
        ...
        <p className="font-bold text-xl mb-1.5">{price}</p>
      </div>
      <div className="text-white px-2.5 flex justify-between">
